...
import com.demat.invoice.security.AuthoritiesConstants;
import com.demat.invoice.security.SecurityUtils;
import com.demat.invoice.security.oauth2.AudienceValidator;
import com.demat.invoice.security.oauth2.JwtGrantedAuthorityConverter;
import com.demat.invoice.service.KeycloakAuthorizationService;
import com.demat.invoice.web.filter.SpaWebFilter;
...
public class SecurityConfiguration {
    ...
    @Bean
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http, KeycloakAuthorizationService authorizationService) {
        // @formatter:off
        http
        ...
        .and()
            ...
            .pathMatchers("/api/gateway/**").access(new CustomReactiveAuthorizationManager(authorizationService, "gateway", "READ"))
